...
<head>
	...
	<title>Car Rental | Post Vehicle</title>
...
<div class="form-group">
<label class="col-sm-2 control-label">Price Per Day(SAR)<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<label for="leatherseats"> Leather Seats </label>
		...
		<div class="col-sm-8 col-sm-offset-4">
            <button style="float: right" class="btn btn-primary" name="submit" type="submit">Save changes</button>

            <button style="float: right" class="btn btn-default" type="reset">Cancel</button>
												</div>
            <br><br>
											</div>
